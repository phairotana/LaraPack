@foreach($entry->property->units as $unit)
<div class="card">
              ...
              <tr class="collapse" id="collapseUnit">
                <td colspan="7">
                  <div class="contact-information-content">
                    {{-- <a class="example-image-link " href="https://testing.z1central.com/thumbnail/large/uploads/images/202007/cf7cb31d46c141f4a1b89e8ed6d1af33.jpg" data-lightbox="example-1">
                      <img class="example-image img-thumbnail mr-1 mb-2" src="https://testing.z1central.com/thumbnail/large/uploads/images/202007/cf7cb31d46c141f4a1b89e8ed6d1af33.jpg" alt="image-1" style="height: 80px">
                    </a> --}}
                    @foreach ($entry->property->title_deed_photos as $key => $title_deed_photo)
                      ...
                      <table class="table border mb-0">
                        <thead class="thead-light">
                          <tr>
                            ...
                            <th>Length</th>
                            <th>Area</th>
                            <th class="text-nowrap">Cost Estimates</th>
                            <th class="text-nowrap">Effective Ages</th>
                            <th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td colspan="7"><p class="mb-0 text-center font-weight-bold">Empty floor</p></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                    <div class="text-right">
                      <button type="button" id="macf-floor14-button" class="btn btn-primary btn-sm mt-2 macf-floor14-button"><i class="fa la la-plus"></i>Add Floor
                      <!----></button>
                    </div> --}}
  ...
  <div class="card-footer" style="">
    <button type="button" id="macf-building-button" class="btn btn-primary float-right macf-building-button"><i class="la la-plus"></i>Add Building
    <!----></button>
    </div>
</div>
@endforeach